...
function Update({ reload, ruangan }: { reload: Function; ruangan: Ruangan }) {
      ...
      >
        <form onSubmit={handleSubmit}>
          <Modal.Header closeButton>
            <Modal.Title>Update Ruangan</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <div className="mb-3 row">
              <label className="col-sm-4 col-form-label">Nama Ruangan</label>
